...
def main():
    ...
    if "cityscapes" in data_root:
    ...
    elif "ISPRS(512)" or "ISPRS" in data_root:
        colormap = create_ISPRS_label_colormap()
        for line in open(f_data_list, "r"):
            arr = [
                "JPEGImages/{}.jpg".format(line.strip()),
                "SegmentationClassAug/{}.png".format(line.strip()),
        ...
        for line in open(f_data_list, "r"):
            arr = [
                "JPEGImages/{}.png".format(line.strip()),
                "SegmentationClassAug/{}.png".format(line.strip()),
            ]
            arr = [os.path.join(data_root, item) for item in arr]
            data_list.append(arr)
    ...
    elif "pascal" in cfg["dataset"]["type"]:
        valiadte_whole(
            model,
            num_classes,
            data_list,
    ...
    elif "ISPRS_semi" in cfg["dataset"]["type"]:
        valiadte_ISPRS(
            model,
            num_classes,
            data_list,
