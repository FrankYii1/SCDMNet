...
def fcn_resnet50(aux, num_classes=6, pretrain_backbone=False):
...
def fcn_resnet101(aux, num_classes=6, pretrain_backbone=True):
    ...
    classifier = FCNHead(in_planes, num_classes)
